    ...
    <Well className="contactPadd">
      ...
      <Row >
        <Col sm={6} className="center miniSpacer">
          <Image className="aboutImages" src="https://s3-us-west-1.amazonaws.com/zollstorage/portfolio/design-tools.png"  />
        </Col>
        <Col sm={6} className="center miniSpacer">
          <Image className="aboutImages" src="https://s3-us-west-1.amazonaws.com/zollstorage/portfolio/developer-tools.png"  />
        </Col>
      </Row>
    </Well>
  </div>
